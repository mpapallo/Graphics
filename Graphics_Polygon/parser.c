...
void parse_file ( char * filename, 
  ...
  while ( fgets(line, 255, f) != NULL ) {
    ...
    if (!strcmp(line, "line")){
      ...
      sscanf(fgets(line, 255, f), "%lf %lf %lf", &x0, &y0, &q0);
      add_circle(pm, x0, y0, q0, 0.1);
      ...
      sscanf(fgets(line, 255, f), "%lf %lf %lf", &x0, &y0, &q0);
      add_sphere(pm, x0, y0, q0, 1);
    }else if(!strcmp(line, "torus")){
      sscanf(fgets(line, 255, f), "%lf %lf %lf %lf", &x0, &y0, &q0, &q1);
      add_torus(pm, x0, y0, q0, q1, 1);
